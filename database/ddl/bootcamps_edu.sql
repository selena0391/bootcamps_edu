...
create table bootcamps_edu.Program_Location
(
	id int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
(
	id int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	program_location_id int not null REFERENCES bootcamps_edu.Program_Location (id),
...
(
	id int PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	program_date_id int not null REFERENCES bootcamps_edu.Program_Date (id),
